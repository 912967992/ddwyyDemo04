...
public class DingTalkUserCacheService {
    ...
    public static class UserInfo {
        ...
        public UserInfo(String userId, String username, String job, String departmentId, String departmentName,
                       String corpId, String templatespath, String imagepath, String savepath) {
            this.userId = userId;
                ...
                try {
                    ...
                    if (cachedData != null && !cachedData.isEmpty()) {
                        ...
                        if (username.equals(cachedUsername)) {
                            ...
                            userInfo.setDepartmentName((String) cachedData.get("departmentName"));
    ...
    public void cacheUserInfo(UserInfo userInfo) {
        try {
            ...
            if (userInfo.getDepartmentName() != null && !userInfo.getDepartmentName().isEmpty()) {
                redisService.hSet(cacheKey, "departmentName", userInfo.getDepartmentName());
            }
